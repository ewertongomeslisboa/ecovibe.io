...
export default function HomePage({ onNavigate }: HomePageProps) {
  ...
  <section
    ...
    style={{
      backgroundImage: "url('/floresta.gif')",
      backgroundSize: "cover",
      backgroundPosition: "center center",
      backgroundRepeat: "no-repeat",
      backgroundAttachment: "fixed", // dá um efeito bonito de parallax
    }}
  >
    ...
    <div className="relative z-10 text-center px-4">
      ...
      <p className="text-xl md:text-2xl text-emerald-50 max-w-3xl mx-auto leading-relaxed drop-shadow">
