...
export default function HomePage({ onNavigate }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <section className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 text-white relative">
      ...
      <img
        src="/floresta.gif"
        alt="Floresta"
        className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-3xl pointer-events-none select-none"
        style={{ zIndex: 1 }}
      />
      </section>
