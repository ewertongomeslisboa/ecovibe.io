  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Olá! Sou o assistente ambiental Ecovibe. Posso responder perguntas sobre meio ambiente, sustentabilidade, reciclagem, mudanças climáticas e muito mais. Como posso ajudar você hoje?',
      timestamp: new Date(),
    },
  ]);
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-800 mb-4">IA Ambiental Ecovibe</h1>
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-4 flex items-center gap-3">
            ...
            <div className="text-white">
              <p className="font-semibold">Assistente Ecovibe</p>
